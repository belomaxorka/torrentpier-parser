 ...
 * @license MIT License
 */
function xxxtorrents($text, $curl = null, $tracker_data = null)
{
	// ------------------- Get title -------------------
	...
	for ($i = 0; $i <= 20; $i++) {
		...
		$text = preg_replace('/<span class="sp-wrap"><span class="sp-body" title="([^<]*?)">([^<]*?)<(?=\/)\/span><(?=\/)\/span>/', "[align=center][spoiler=\"\\1\"]\n\\2\n[/spoiler][/align]", $text);
